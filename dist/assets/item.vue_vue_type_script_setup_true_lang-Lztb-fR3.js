import{_}from"./children.vue_vue_type_script_setup_true_lang-IFy7_lT1.js";import{s as h}from"./ai-XCy4e5jC.js";import{Z as E,J as g,q as k,r as x,d as I,o as b,z as S,c as s,e as i,f as B,t as d,F as y,g as A,h as w,C}from"./index-uMhRcJzO.js";const z="/assets/aiassistant-3mBxNB_k.png";let f=0;const M=E("ai",()=>{const n=g([]),a=k(),l=x(!1),e={toeflType:"",queryType:"",chatbotQuery:"","Main Content":"",mcq:"",problemMethod:""};return{init:async()=>{l.value||(n.push({type:"receive",name:"鹦鹉AI助教",isEnd:!1,id:"init",content:[`Hi
 there! 
Nice 
to 
meet 
