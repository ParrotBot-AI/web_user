import{_ as v}from"./children.vue_vue_type_script_setup_true_lang-ZyUylKnd.js";import{Z as _,M as g,C as E,p as k,r as f,d as b,o as I,v as S,c as t,e as a,f as B,t as p,F as y,g as A,h as M,y as w}from"./index-nx37jhkW.js";const j="/assets/aiassistant-3mBxNB_k.png",C="http://18.136.105.171:57875",N=async n=>_.post(C+"/v1/modelapi/streaming/",n);let x=0;const T=g("ai",()=>{const n=E([]),s=k(),r=f(!1),e={toeflType:"",queryType:"",chatbotQuery:"","Main Content":"",mcq:"",problemMethod:""};return{init:async()=>{r.value||(n.push({type:"receive",name:"鹦鹉AI助教",isEnd:!1,id:"init",content:[`Hi
 there! 
Nice 
to 
meet 
