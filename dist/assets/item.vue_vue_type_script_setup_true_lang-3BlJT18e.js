import{_ as h}from"./children.vue_vue_type_script_setup_true_lang-XMM5psMS.js";import{X as _,Y as g,C as E,p as b,r as f,d as k,o as I,v as S,c as t,e as a,f as B,t as p,F as y,g as A,h as w,y as C}from"./index-xyv-xine.js";const O="/assets/aiassistant-3mBxNB_k.png",M="/ai-api",N=async n=>_.post("/v1/modelapi/streaming/",n,{baseURL:M});let x=0;const T=g("ai",()=>{const n=E([]),s=b(),r=f(!1),e={toeflType:"",queryType:"",chatbotQuery:"","Main Content":"",mcq:"",problemMethod:""};return{init:async()=>{r.value||(n.push({type:"receive",name:"鹦鹉AI助教",isEnd:!1,id:"init",content:[`Hi
 there! 
Nice 
to 
meet 
