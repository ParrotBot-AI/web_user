import{_}from"./children.vue_vue_type_script_setup_true_lang-jK_I8hb4.js";import{s as h}from"./ai-n6vjZp9C.js";import{Y as E,G as g,q as k,r as x,d as I,o as b,x as S,c as s,e as i,f as A,t as d,F as y,g as B,h as w,A as M}from"./index-44Gk_Eht.js";const O="/assets/aiassistant-3mBxNB_k.png";let f=0;const N=E("ai",()=>{const n=g([]),a=k(),l=x(!1),e={toeflType:"",queryType:"",chatbotQuery:"","Main Content":"",mcq:"",problemMethod:""};return{init:async()=>{l.value||(n.push({type:"receive",name:"鹦鹉AI助教",isEnd:!1,id:"init",content:[`Hi
 there! 
Nice 
to 
meet 
