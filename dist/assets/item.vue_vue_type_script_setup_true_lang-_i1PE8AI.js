import{_}from"./children.vue_vue_type_script_setup_true_lang-JNOOzlW4.js";import{s as h}from"./ai-cH4_-axW.js";import{X as g,C as E,p as k,r as x,d as I,o as b,v as S,c as t,e as a,f as B,t as d,F as y,g as A,h as w,y as C}from"./index-QdoVddfu.js";const O="/assets/aiassistant-3mBxNB_k.png";let f=0;const M=g("ai",()=>{const n=E([]),s=k(),r=x(!1),e={toeflType:"",queryType:"",chatbotQuery:"","Main Content":"",mcq:"",problemMethod:""};return{init:async()=>{r.value||(n.push({type:"receive",name:"鹦鹉AI助教",isEnd:!1,id:"init",content:[`Hi
 there! 
Nice 
to 
meet 
