    ...
    <div class="container h-full flex relative mx-auto">
      <div class="absolute w-[380px] left-10 top-1/2 -translate-y-1/2 z-1">
        ...
        <a-form :model="formState" layout="vertical" class="mt-10" @finish="onFinish">
          <a-form-item label="怎么称呼您呢？" name="username" :rules="[{
            required: true,
            message: '请输入您的昵称'
          }]">
            <a-input v-model:value="formState.username" type="tel" class="py-2.5 px-3.5" placeholder="输入昵称">
            </a-input>
          </a-form-item>
          <a-form-item>
            <a-button type="primary" html-type="submit" class="shadow-none w-full px-4 py-2.5 h-auto mt-4"
              :loading="loading">下一步</a-button>
          </a-form-item>
        </a-form>
      </div>
