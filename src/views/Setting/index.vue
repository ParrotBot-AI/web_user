<template>
    ...
    <a-tabs class="w-full h-full page-tab-setting">
      ...
      <a-tab-pane key="2" tab="关于鹦鹉智学" class="w-full h-full flex items-center justify-center">
        ...
        >
          ...
          <h1 class="text-[26px] flex w-1/2 items-start justify-start pt-10">
            {{ $t('隐私条款') }}
          </h1>
          <a-form-item name="code">
            <a-input
            ...
            <div class="flex items-center h-full justify-between">
              <div class="flex flex-col mt-2" style="width: 30%">
                <img :src="erweima" style="width: 127px" />
                <div class="w-[127px] flex justify-center items-center text-[16px] text-[#475467]">
                  {{ $t('添加企业微信') }}
                </div>
              </div>
  ...
  >
    ...
    <a-form-item name="mobile">
      ...
      <a-input type="tel" class="py-2 px-3.5" :placeholder="$t('请输入新手机号')"> </a-input>
    </a-form-item>
