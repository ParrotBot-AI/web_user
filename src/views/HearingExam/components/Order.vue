  ...
  <div class="px-32">
    ...
    <div>
      <DropBox
        ...
        :onDrop="onDrop"
        :onDel="onDel"
        :accept="props.answer.map((val, i) => `${i}`)"
        :index="i"
      ></DropBox>
    </div>
    ...
    <div class="py-2 px-4 mt-4 bg-[#F6F6F6] text-[#475467] text-base">
      Directions: Drag your answer choices to the spaces here they belong. To remove an answer
      choice, click on it. To review the passage, click VIEW TEXT.
    </div>
  </div>
</template>
